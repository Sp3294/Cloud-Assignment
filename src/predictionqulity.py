...
if __name__ == "__main__":
    ...
    spark = SparkSession.builder \
        .appName('CS643_Programming_Assignment_2') \
        .getOrCreate()
    ...
    if len(sys.argv) > 3:
        ...
        input_path = "s3://asscloudbucket/TrainingDataset.csv"
        valid_path = "s3://asscloudbucket/ValidationDataset.csv"
        output_path="s3://asscloudbucket/testmodel.model"
